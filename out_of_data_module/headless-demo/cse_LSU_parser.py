...
@file: cse_LSU_parser.py

@time: 2018/10/23 下午2:42
...
def get_info(url, major):
    ...
    try:
        html = fetch(url)
        tmp = extract('//div[@class="col-md-9"]/div[@class="col-md-4"]', html, True)
        # print(tmp)
    except:
...
get_info("https://www.lsu.edu/eng/cse/people/faculty/index.php", \

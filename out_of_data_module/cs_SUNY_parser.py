...
@file: cs_SUNY_parser.py

@time: 2018/7/14 下午9:54
...
def getInfo(url, major):
    ...
    tmp = extract("//div[@class='par parsys']", res, True)
...
getInfo("https://engineering.buffalo.edu/computer-science-engineering/people/faculty-directory.html", \

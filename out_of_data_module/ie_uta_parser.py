...
@file: ie_uta_parser.py

@time: 2018/8/7 下午8:35
...
@file: bio_uta_parser.py

@time: 2018/8/7 下午4:59
...
def getInfo(url, major):
    ...
    for each in tmp:
        ...
        # print(url)
        if url is not None:
            pic_url = "http://www.uta.edu/ie/" + url.split("./")[-1]
        else:
            pic_url = ""
        email = re.search(r'Email: <a href="(.*?)">', source, re.S)
...
getInfo("http://www.uta.edu/ie/faculty-staff/index.php", \

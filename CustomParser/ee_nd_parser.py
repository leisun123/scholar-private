...
if __name__ == '__main__':
    from SampleData.ee_nd import base_url,sample_url,data,item_url_rule
    EENdTask = CommonTask(website_name=EENdClass.__name__,
                   custom_parser=EENdClass,
                   base_url=base_url,

#coding:utf-8
"""
@file:      eecs_berkeley_parser
@author:    IsolationWyn
@contact:   genius_wz@aliyun.com
@python:    3.5.2
@editor:    PyCharm
@create:    2017/7/26 18:27
@description:
            --
"""
import os
...
from ScholarConfig.eecs_berkeley_rule  import RULES
from nameparser import HumanName
PS_ERROR = lambda func:except_pass(func,ModelName = 'eecs_utexas')

class EECSUtexasClass(ThesisInfo):
    def __init__(self,sec):
        """
        :param sec: item url
        """
        self.sec = sec
        super(EECSUtexasClass, self).__init__()
    ...
    def _generate_major(self):
        self.major = "Electrical Engineering and Computer Sciences"
...
if __name__ == '__main__':
    ...
    html= fetch("https://www2.eecs.berkeley.edu/Faculty/Lists/list.html?_ga=2.157267064.273235644.1500137616-1698500221.1500137605")
    #print(html)
